  ...
  return (
    <div className={`mt-16 px-32 flex flex-row align-middle items-center `}>
      ...
      <div className='w-3/4 pl-20'>
        ...
        <div className='mt-5'>
            <h4 ref={ref1} className={`flex space-x-3 text-gray-700 bg-memop/5 rounded-2xl px-5 py-3 my-4 hover:bg-memop/10 ${inView1 ? 'animate__animated animate__fadeInUp animate__delay-1s' : ''}${inView1 ? 'animate__animated animate__fadeInUp animate__delay-1s' : ''}`}><CircleCheckBig className='text-memop'/><span className='font-semibold'>Capture & Relive -</span> – Store life’s best moments in interactive timelines.</h4>
            <h4 ref={ref2} className={`flex space-x-3 text-gray-700 bg-memop/5 rounded-2xl px-5 py-3 my-4 hover:bg-memop/10 ${inView2 ? 'animate__animated animate__fadeInUp animate__delay-2s' : ''}`}><CircleCheckBig className='text-memop'/><span className='font-semibold'>Collaborate -</span> – Build shared memory albums with friends & family.</h4>
